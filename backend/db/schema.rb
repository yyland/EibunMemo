...
ActiveRecord::Schema[7.0].define(version: 2023_07_18_163520) do
  create_table "english_texts", force: :cascade do |t|
    t.string "title"
    t.text "text"
  ...
  create_table "memos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["memo_word_id"], name: "index_memos_on_memo_word_id"
  end
