...
長い時間メモアプリを使っていく中で、理想のメモアプリの構想が膨らんでいたので、同じような理想を持っている人もいるはずだと思い、自分で開発して公開したいと思いました。  
...
| ゲストユーザーとして機能を試すことができます。 | 左：登録済みテキストをリスト表示します。 <br> 中央：テキスト内容をを表示します。メモした文字に下線が引いてあります。 <br> 右：メモ内容を表示します。 |
